...
var NOTIFICATION_RECIPIENTS = "dwynn@sitesphil.com";
// Google Sheet URL that you have access to edit (should be blank to begin with)
var GOOGLE_SHEET_URL = "https://docs.google.com/spreadsheets/d/14aJHDBgFZD1jLATxjNBS9ft4paonjwSwva44GIunYFU/edit#gid=0";
...
// Check if sharing access is set to "ANYONE WITH A LINK"
if (thisFile.getSharingAccess() === DriveApp.Access.ANYONE_WITH_LINK) {
